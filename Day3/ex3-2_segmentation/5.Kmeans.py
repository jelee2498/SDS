...
# image -> RGB vector conversion (collpase pixel position information)
...
while deltaMeans > convergeLimit and iterN < maxIter:
    ...
    # assign clusters according to dist2Centers
    #---------- YOUR CODE HERE ----------#
    """
...
# reconstruct pixel position information (for visulization purpose)
